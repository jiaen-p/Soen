...
app.get("/conversations/:user_id", function (req, res) {
    ...
    connection.query(query, [user_id, user_id, user_id, user_id, user_id, user_id, user_id, user_id, user_id, user_id], function (err, data) { return __awaiter(void 0, void 0, void 0, function () {
